...
--
-- Máy chủ: 127.0.0.1
-- Thời gian đã tạo: Th5 18, 2020 lúc 02:34 AM
...
(13, ' A-Bphone-B86', 1, 1),
(14, 'iPad-Mini-5-7.9-Wi-Fi/64GB', 1, 1),
(17, 'Vsmart-Joy-2-plus2/32', 4, 1),
(18, 'iPhone-11-128GB', 1, 1);
...
(' A-Bphone-B86s', ' Bphone B86s', 'sm-android', ' A-Bphone-B86', 'BOS 8.6 (Android 9)', '4/128GB', 'Chipset: Qualcomm Snapdragon 675, 8 nhân: 2 nhân 2.0GHz Kryo Gold, 6 nhân 1.7GHz Kryo Silver<br>Chip đồ họa (GPU): Qualcomm® Adreno™ 612 GPU', 'Camera AI - Tiên phong nhiếp ảnh điện toán. Camera chính PDAF Dual pixel 2 cảm biến trong 1 ống kính (12Mp cho ảnh + 12Mp cho lấy nét), khẩu độ F/1.8 lấy nét cực nhanh và camera phụ hỗ trợ xóa phông', '3000mAh', 50, 8000000, 9990000, 'Bkav', '6.1 inches, công nghệ COF<br>Tràn đáy, Full HD+, rất nhạy & sáng', 'bphone-b86-thumb-tam-1-600x600.jpg', '2020-05-12 17:16:45'),
...
('Nokia-230', 'Nokia 230', 'normal-nokia', 'Nokia-230', 'null', 'null', 'null', 'Camera sau :2Mp Camera trươc : 2Mp', '1200 mAh', 20, 990000, 1250000, 'Nokia', '2.8 inches, QVGA, 240 x 320 Pixels', 'nokia230.jpg', '2020-04-27 13:55:06'),
('Nokia-5310', 'Nokia 5310', 'normal-nokia', 'Nokia', ' Nokia S30+', '8/4MB', 'n/a', 'Camera sau : 0.4Mp', '1200 mAh', 10, 500000, 649000, 'Nokia', ' 2.4 inches, QVGA, 320 x 240 Pixel', 'nokia-5310-2020-den-1.png', '2020-04-27 14:05:24'),
...
('Nokia-n150', 'Nokia N150', 'normal-nokia', 'Nokia', 'n/a', 'n/a', 'n/a', 'Camera sau : VGA (480 x 640 pixels)', '1020 mAh', 10, 400000, 649000, 'Nokia', 'TFT, 2.4\", 65.536 màu, QVGA, 320 x 240 Pixels', 'nokia-n150.jpg', '2020-04-27 14:01:13'),
...
(1, 'Phạm Quang Thịnh', '1999-04-14', 'pqthinh0@gmail.com', '0123456789', '123', '2020-04-28 09:37:21', NULL),
(2, 'pham quang thu', '2000-05-11', 'thu@gmail.com', '213434rew', '123', '2020-05-11 20:38:41', NULL),
(3, 'pq thinh1', '1998-05-14', 'thinh_test@gmail.com', '0866564502', '123', '2020-05-14 19:02:07', NULL),
(4, 'admin', '2002-05-12', 'admin@gmail.com', '0123456789', 'admin', '2020-05-14 19:11:40', NULL);
...
--
ALTER TABLE `giohang`
  MODIFY `idgiohang` int(12) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=19;
...
--
ALTER TABLE `image`
  MODIFY `id_image` int(12) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=16;
