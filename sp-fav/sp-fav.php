...
<body>
    ...
    <!-- Xem danh mục sp ưa thích -->
    
    <div class="container" style="margin-top: 30px;">
        <p style="text-align: center;color: greenyellow">Sản phẩm đã cho vào danh mục sp ưa thích</p>
        <p style="text-align: center;color: greenyellow"></p>
        <div class="row" style="margin-top: 30px;margin-left: 20%;width: 60%;">
            <table class="table" style="text-align: center;position: relative; left:10%;margin: 0 15px;" id="table_t">
                <tr>
                    <th></th>
                    <th>Tên sp</th>
                    <th>Giá</th>
            ...
            <?php
                ...
                $idthanhvien='';
                if(mysqli_num_rows($result)<=0) {
                    echo '<tr><p style="color: red;margin-bottom: 30px; margin-left: 100px; ">';
                    echo 'Chưa có sản phẩm nào được thêm vào danh mục này của bạn</p></tr>';
                }
                else {
                    ...
                    <tr style="height: 100px;">
                            ...
                            <td><a href="delfav.php?remove=<?php echo $row1['id']; ?>"><i class="fa fa-trash"></i></a> </td>
