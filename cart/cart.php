...
<!--			<div class="trang-chu"><a href="<?php //if($_SESSION['ten']=='admin') echo '../temp-quantri.php'; else echo '#';?>">Mục quản trị viên</a></div>-->
    ...
    <div class="container" style="margin-top: 30px;">
        <p style="text-align: center;color: greenyellow">Sản phẩm đã cho vào giỏ hàng</p>
        <p style="text-align: center;color: greenyellow">Thay đổi số lượng sp bằng cách forcus vào ô số lượng của dòng rồi forcusout</p>
        <div class="row" style="margin-top: 30px;margin-left: 20%;width: 60%;">
            <table class="table" style="text-align: center; left: 10%;margin-left: 5%;" id="table_t">
                <tr>
                <th></th>
	  	<th>Tên sp</th>
	  	<th>Giá</th>
            ...
            <?php
                ...
                $idthanhvien='';
                if(mysqli_num_rows($result)<=0) {
                    echo '<tr><p style="color: red; text-align: center;">';
                    echo 'Chưa có sản phẩm nào được thêm vào giỏ hàng của bạn</p></tr>';
                }
                else {
                    ...
                    <tr style="height: 100px;">
                            ...
                            <td>
                                <div contentEditable='true' class='edit' id="<?php echo $row1['idgiohang']; ?>"><?php echo '<p>'.$row1['soluong']."</p>";?>
                                </div>
                            </td>
                            <td><a href="deletecart.php?remove=<?php echo $row1['idgiohang']; ?>"><i class="fa fa-trash"></i></a> <?php //echo $row['nameproduct']; ?></td>
            ...
            ?>	  
                        ...
                        <tr>
                            ...
                            <td><a href="../index.php">Xem thêm sp khác</a></td>
                        </tr>
                        <?php 
                        if($total>0)
                            echo '<tr>'.
                                '<td><a href="../cart/thanhtoan.php?id='.$idthanhvien.'" class="btn btn-info">Thanh toán</a></td>
                            </tr>';
                        ?>
	  </table>
	</div>
...
<script>
  $(document).ready(function(){
    ...
    $(".edit").focusout(function(){
        ...
        if(value <=0 ) {
            value=1;
            alert('Bạn nhập số lượng không hợp lệ');
        }
        $.ajax({
           url: 'update_cart.php',
           type: 'POST',
           data: { soluong:value , id:id },
