...
<?php
    ...
    if(isset($_POST['xacnhan'])) {
        ...
        // Lấy thông tin nhân viên đang có ít khách nhất để thêm vào khách hàng
            ...
            //Lấy lastID()
            $rowid= mysqli_query($conn, "select id from customer where email=(select email from thanhvien where id= ".$_SESSION['id'].");");
...
<div style="display: flex;width: 800px;margin: auto;">
    <div class="form">
        <form action="" method="POST">
            ...
            <?php 
                if($_SESSION['ten']== 'admin') echo "Admin không thể thanh toán vì có thể làm hỏng database";
                else 
                    echo '<div><input type="submit" name="xacnhan" class="save" value="Xác nhận"/></div>';
            ?>
